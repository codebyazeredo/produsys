...
<div id="positions-container">
    @foreach(old('positions', $positions ?? []) as $position)
        <div class="flex items-center mb-2">
            <input type="text" name="positions[]" class="w-full p-2 border text-gray-900 border-gray-300 rounded mt-2" placeholder="Nome da Posição" value="{{ $position['name'] ?? '' }}">
